<?php
  ...
  while ($edit = $stmtselect->fetch(PDO::FETCH_ASSOC)) {
    if($edit['status'] == 'Arrival' || $edit['status'] == 'In-house' || $edit['status'] == 'Departure'){
      if($edit['plan'] == 'Single room' || $edit['plan'] == 'Single_room'){
        $single++;
      }if($edit['plan'] == 'Double room' || $edit['plan'] == 'Double_room'){
        $double++;
      }if($edit['plan'] == 'Deluxe room' || $edit['plan'] == 'Deluxe_room'){
        $deluxe++;
      }
    }
  }
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                ...
                <tbody>
                  <td><?php echo 15 - $single ?></td>
                  <td><?php echo 15 - $double ?></td>
                  <td><?php echo 15 - $deluxe ?></td>
                </tbody>
              </table>
            </div>
